...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Runs python file relative to the working directory",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="Runs python file content, relative to the working directory (default is the working directory itself)",
            ),
        },
    ),
)